...
def run_user_seeder(db: Session):
    ...
    create_user_with_relevant_rows(db=db, country_id=1, currency_id=1, username="merchanthead", email="kiceej@gmail.com", phone_number="+2347063520766", password="secret", user_type=3, role=1, first_name="Merchant", other_name="Head", last_name="User", is_merchant=True, merchant_name="Kiceej Inc.")
