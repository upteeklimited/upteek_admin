...
def create_provider(db: Session, name: str = None, description: str = None, code: str = None, status: int = 0):
...
def delete_provider(db: Session, id: int=0):
    values = {
...
def force_delete_provider(db: Session, id: int=0):
