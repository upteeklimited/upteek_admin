...
def create_transaction_type(db: Session, corresponding_gl_id: int = 0, charge_gl_id: int = 0, name: str = None, description: str = None, code: str = None, action: int = 0, chargeable: int = 0, charge_type: int = 0, charge_percentage: float = 0, charge_flat: float = 0, charge_flatmax_amount: float = 0, require_approval: int = 0, require_approval_amount: float = 0, is_system: int = 0, status: int = 0, created_by: int = 0, authorized_by: int = 0, authorized_at: str = None):
...
def update_transaction_type(db: Session, id: int=0, values: Dict={}):
    values['updated_at'] = get_laravel_datetime()
    db.query(TransactionType).filter_by(id = id).update(values)
    db.flush()
    return True

def delete_transaction_type(db: Session, id: int=0):
    values = {
...
def force_delete_transaction_type(db: Session, id: int=0):
