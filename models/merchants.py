...
def create_merchant(db: Session, user_id: int = None, category_id: int = None, name: str = None, trading_name: str = None, description: str = None, email: str = None, phone_number_one: str = None, phone_number_two: str = None, opening_hours: str = None, closing_hours: str = None, logo: str = None, thumbnail: str = None, certificate: str = None, memorandum: str = None, utility_bill: str = None, building: str = None, compliance_status: int = 0, compliance_approved_by: int = None, compliance_approved_at: str = None, compliance_rejected_by: int = None, compliance_rejected_at: str = None, status: int = 0):
...
def update_merchant(db: Session, id: int=0, values: Dict={}):
    values['updated_at'] = get_laravel_datetime()
    db.query(Merchant).filter_by(id = id).update(values)
    db.flush()
    return True

def delete_merchant(db: Session, id: int=0):
    values = {
...
def force_delete_merchant(db: Session, id: int=0):
