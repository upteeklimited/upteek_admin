...
def create_user(db: Session, country_id: int = None, merchant_id: int = None, username: str = None, email: str = None, phone_number: str = None, password: str = None, device_token: str = None, user_type: int = 0, role: int = 0, status: int = 0):
