...
def create_collection(db: Session, loan_id: int = 0, amount: float = 0, total_principal: float = 0, total_interest: float = 0, bal_principal: float = 0, bal_interest: float = 0, retrial_num: int = 0, status: int = 0, retrial_status: str = None, collected_at: str = None, deleted_at: str = None):
...
def force_delete_collection(db: Session, id: int=0):
